...
Refinement_offset = DefineNumber[ 0.3518499259346596, Name "Parameters/Refinement_offset" ];
N_refinement = DefineNumber[ 61.0, Name "Parameters/N_refinement" ];
...
Plane Surface(9) = {9};
Plane Surface(10) = {10};
Transfinite Curve {-4, -20, 2} = N_inlet Using Bump 10; 
...
Physical Curve ("airfoil", 2) = {1, 3, 2}; 
Physical Curve ("inlet", 3) = {4}; 
Physical Curve ("outlet", 4) = {15, 16, 18}; 
Physical Curve ("limits", 5) = {5, 6, 7, 10}; 
Physical Point ("airfoil", 6) = {26, 37, 1}; 
Physical Point ("limits", 7) = {61, 62, 65, 66, 63, 64}; 
Physical Point ("outlet", 8) = {67, 72, 73}; 
